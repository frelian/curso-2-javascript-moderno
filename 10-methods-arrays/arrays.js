...
const char = Array.from(sentence);

// const list = document.querySelectorAll("li");
// const list = Array.from(document.querySelectorAll("li"));
// const learn = list.map(element => element.textContent)

const learn = Array.from(
    document.querySelectorAll("li"),
    element => element.textContent
)

// Para tratar los argumentos de una funcion
function total(num1, num2, num3, num4, num5, num6) {
    return Array.from(arguments).reduce((prev, next) => prev + next, 0);
}

console.log(total(1234, 245, 2352, 7678, 93434, 356))
...
// Array find
const emaile = "umut.velioglu@example.com";
const selectedUser = users.find(user => user.email === emaile);
const namesSelectedUser = users.find(user => user.email === emaile).name;
const lastNameSelectedUser = users.find(user => user.email === emaile).name.last;

// Array findIndex
// 2a60d53c-24f2-4409-9990-2f5fd55d14eb
const uuid = "2a60d53c-24f2-4409-9990-2f5fd55d14eb";
const selectedIndex = users.findIndex(user => user.login.uuid === uuid);
console.log(selectedIndex)

// Puedo eliminar el indice, como parametro envio en indice y numero de elementos en el array a eliminar
...
// Array includes
console.log(Array.of(1, 2, 3, 4, 5).includes(7))
